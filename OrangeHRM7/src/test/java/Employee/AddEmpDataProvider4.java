...
public class AddEmpDataProvider4
{
 ...
 public  static String FirstName, MiddleName, LastName, Id, PhotoPath;
	...
	public  void AddEmpDataProvider4(WebDriver driver,
	...
	{  
			...
			AE.AddEmpDataProvider4(driver,HtmlOutputFileName,TH3 );
	 ...
	 public static  void PassDriver_To_LoginPage() throws Exception 
	 {
		...
		//Login(driver ,HtmlOutputFileName,TH3);
		//UserName=UserName;
		//Password=Password;
	 ...
	 public   void TC01_Add_Employee_OpenChromeBrowser() throws Exception 
	 {
