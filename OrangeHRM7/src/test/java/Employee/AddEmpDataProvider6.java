...
public class AddEmpDataProvider6
{
...
public void AddEmpDataProvider6(WebDriver driver, String HtmlOutputFileName, TestHTMLReporter7 TH3) throws Exception {
	this.driver = driver;
...
public void AddEmployee_call_allmethods(String UserName, String Password,
		String FirstName, String MiddleName,String LastName, String Id, String PhotoPath) throws Exception {
	...
	AddEmpDataProvider6 AE = new AddEmpDataProvider6();
	AE.AddEmpDataProvider6(driver, HtmlOutputFileName, TH3);
