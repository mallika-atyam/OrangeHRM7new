...
public class AddEmpDataProvider2
{
	...
	String TestScriptName="TC01_Add_Employee";

	public  void AddEmpDataProvider2(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3 )throws Exception
	{  
			  this.driver=driver;
	...
	{  
				...
				/*mycode:{
			    System.out.println("Hai Sudhakar");
			...
			AddEmpDataProvider2 AE =new AddEmpDataProvider2();
			AE.AddEmpDataProvider2(driver,HtmlOutputFileName,TH3 );
	...
	public   void  AppendHtml(WebDriver driver) throws Exception
	{
		
		iRow++;
	    String str=String.valueOf(iRow);
		TH3.HTMLScreenShot(TestScriptName+"_Iteration_" + str,
