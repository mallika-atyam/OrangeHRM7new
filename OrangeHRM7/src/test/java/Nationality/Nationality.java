...
public static String TestScriptName = "TC01_Nationality";

public void NationalityDataProvider6(WebDriver driver, String HtmlOutputFileName, TestHTMLReporter7 TH3) throws Exception {
	this.driver = driver;
...
public void CreateHTML(String browser) throws Exception {
	...
	if(browser.equalsIgnoreCase("Chrome")){
		...
		HtmlOutputFileName = TH3.CretaeHTMLFile(TestScriptName, "IE");
	}
	
	else if(browser.equalsIgnoreCase("FireFox")){
		driver = TestBrowser.OpenFirefoxBrowser();
		HtmlOutputFileName = TH3.CretaeHTMLFile(TestScriptName, "Firefox");
	}
...
@DataProvider(name = "TC01_Nationality")
...
@Test(dataProvider = "TC01_Nationality")
public void Nationality_call_allmethods(String TestURL,String UserName, String Password,
	...
	Nationality AE = new Nationality();
	AE.NationalityDataProvider6(driver, HtmlOutputFileName, TH3);
	AE.NationalityDetails(Nationality);
...
{  
	...
	try 
	{
	 ...
	 TH3.HTMLScreenShot("Nationality Page - Enter Nationality","Nationality Entered","Pass", HtmlOutputFileName,driver);
