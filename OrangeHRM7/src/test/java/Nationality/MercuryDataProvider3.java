...
import java.util.*;
public class MercuryDataProvider3
{
	WebDriver driver;
	
	
	
	@Test(dataProvider = "TC01_Mercury")
	public void Test1(String Browser,String TestURL,String UserName,String Password) throws Exception {
	...
	@DataProvider(name = "TC01_Mercury")
	public static Object[][] Authentication1() throws Exception {
		
		ExcelApiTest4 eat = new ExcelApiTest4();
		Object[][] testObjArray = eat.getTableArray("C://HTML Report//OrangeHRM6//TC01_Mercury2.xlsx", "Sheet1");
