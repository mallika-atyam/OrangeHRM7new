...
public static String TestScriptName = "TC01_PIM";

public void PIMDataProvider6(WebDriver driver, String HtmlOutputFileName, TestHTMLReporter7 TH3) throws Exception {
	this.driver = driver;
...
@DataProvider(name = "TC01_PIM")
public static Object[][] Authentication1() throws Exception {

	ExcelApiTest4 eat = new ExcelApiTest4();
	Object[][] testObjArray = eat.getTableArray("C://HTML Report//OrangeHRM6//TC01_PIMEMP.xlsx", "Sheet1");
...
public void PIM_Employeelist_call_allmethods(String TestUrl,String UserName, String Password,
	...
	PIM PE = new PIM();
	PE.PIMDataProvider6(driver, HtmlOutputFileName, TH3);
	
	PE.PIMDetails( FirstName,MiddleName,LastName,EMPID);
...
public   void PIMDetails(String FirstName, String MiddleName, String LastName, String EMPID )throws Exception
{  
